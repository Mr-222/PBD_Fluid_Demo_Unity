// Copied from https://github.com/Scrawk/PBD-Fluid-in-Unity
...
public class DrawLines
{
    ...
    private static void DrawVertices(Camera camera, IList<Vector4> vertices, Color color, Matrix4x4 localToWorld,
        IList<int> indices)
    {
        switch (LineMode)
        {
    ...
    private static void DrawVerticesAsLines(Camera camera, Color color, IList<Vector4> vertices, Matrix4x4 localToWorld,
        IList<int> indices)
    {
        if (camera == null || vertices == null) return;
    ...
    private static void DrawVerticesAsTriangles(Camera camera, Color color, IList<Vector4> vertices,
    ...
    private static void DrawVerticesAsTetrahedron(Camera camera, Color color, IList<Vector4> vertices,
        Matrix4x4 localToWorld, IList<int> indices)
    {
        if (camera == null || vertices == null) return;
